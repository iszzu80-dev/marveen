...
function makeCtx(path, searchParams = {}) {
    ...
    return {
        ctx: { req: {}, res: res, path, method: 'GET', url },
...
describe('GET /api/memories agent_id alias', () => {
    ...
    it('?agent_id=agent-a does NOT return agent-b memories', async () => {
        ...
        const agentBLeaked = results.some((m) => m.agent_id === 'agent-b');
