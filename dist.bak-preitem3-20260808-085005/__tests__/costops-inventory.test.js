...
function insertSource(db, id, provider, sourceType = 'usage') {
...
function insertRun(db, provider, status, startedAt, errorCode = null) {
...
function insertLine(db, sourceId, opts) {
    db.prepare(`
