...
const TELEGRAM_CMD = 'bun run --cwd /home/user/.claude/plugins/cache/claude-plugins-official/telegram/0.0.6 --shell=bun --silent start';
const SYNOLOGY_CMD = 'bun run --cwd /home/user/.claude/plugins/efi-src/synology-chat --shell=bun --silent start';
