...
describe('costops warnings', () => {
    ...
    it('expected_invoice_missing fires for a past_due active subscription', () => {
        ...
        syncFixedCostsToLedger(db, c, NOW);
        const summary = getCostSummary(db, c, NOW);
        const subsCfg = { version: 1, subscriptions: [{ id: 'overdue-sub', name: 'Overdue Sub', provider: 'openai', source: 'openai', status: 'active', next_renewal: '2026-07-01', amount_source: 'no_invoice_found' }] };
