...
import { checkThrottle, recordFailure, recordSuccess, isGlobalLimited, runDummyVerify, _resetThrottleForTest, } from '../web/login-throttle.js';
beforeEach(() => {
...
describe('per-username lockout', () => {
    ...
    it('doubles the lock per further failure, capped at 15 min', () => {
        ...
        for (let i = 0; i < 10; i++)
            recordFailure('alice', t0); // way past the cap
