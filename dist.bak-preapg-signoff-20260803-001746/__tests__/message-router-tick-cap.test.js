...
const mockMarkDelivered = vi.fn((..._a) => true);
const mockMarkFailed = vi.fn((..._a) => true);
const mockSessionExistsOnHost = vi.fn((..._a) => false);
vi.mock('../logger.js', () => ({
...
vi.mock('../db.js', () => ({
    getPendingMessages: (toAgent) => {
        if (toAgent)
            return []; // per-agent query for reconnect pre-pass
        return mockGetPendingMessages();
    },
    markMessageDelivered: (...a) => mockMarkDelivered(...a),
    markMessageFailed: (...a) => mockMarkFailed(...a),
    markMessageDone: (..._a) => true,
    createAgentMessage: (..._a) => ({ id: 999 }),
    // card def5a189: OTel trace stubs -- no-ops in this test
    stampMessageTrace: (..._a) => false,
    upsertOtelSpan: (..._a) => undefined,
    closeOtelSpan: (..._a) => false,
}));
...
vi.mock('../web/agent-process.js', () => ({
    ...
    sessionExistsOnHost: (...a) => mockSessionExistsOnHost(...a),
}));
