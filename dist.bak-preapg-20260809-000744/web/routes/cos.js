...
export function listOutbound(db) {
    return db.prepare(`SELECT ledger_id, case_id, action_type, sequence_number, status, external_ref, attempt, updated_at
     FROM outbound_ledger ORDER BY created_at DESC LIMIT 50`).all();
}
