 ...
 */
export function jsonMaybeGzip(req, res, data, status = 200) {
...
function gzipFileCached(filePath, etag, data) {
...
export function serveFile(req, res, filePath, opts = {}) {
    try {
        ...
        const varyHeaders = GZIP_EXTENSIONS.has(ext)
            ? { Vary: 'Accept-Encoding' }
            : {};
