...
// the default.
export function channelsSessionName(mainAgentId) {
...
export function channelsLaunchdLabel(serviceId) {
    return `com.${serviceId}.channels`;
}
export function channelsPlistPath(serviceId) {
...
export function isMainChannelsAgent(name) {
...
export function withoutMainAgent(names) {
