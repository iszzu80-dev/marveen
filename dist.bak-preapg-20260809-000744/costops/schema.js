...
export function initCostOpsSchema(db) {
    ...
    try {
        db.exec(`ALTER TABLE token_usage ADD COLUMN provider TEXT`);
    }
    catch { /* column already exists */ }
    try {
        db.exec(`ALTER TABLE token_usage ADD COLUMN model_source TEXT`);
    }
    catch { /* column already exists */ }
  ...
  `);
    ...
    try {
        db.exec(`ALTER TABLE cost_sources ADD COLUMN lifecycle_state TEXT NOT NULL DEFAULT 'active'`);
    }
  ...
  `);
    ...
    try {
        db.exec(`ALTER TABLE cost_line_items ADD COLUMN original_amount REAL`);
    }
    catch { /* already exists */ }
    try {
        db.exec(`ALTER TABLE cost_line_items ADD COLUMN original_currency TEXT`);
    }
    catch { /* already exists */ }
    try {
        db.exec(`ALTER TABLE cost_line_items ADD COLUMN fx_rate REAL`);
    }
    catch { /* already exists */ }
    try {
        db.exec(`ALTER TABLE cost_line_items ADD COLUMN fx_date INTEGER`);
    }
    catch { /* already exists */ }
    ...
    try {
        db.exec(`ALTER TABLE cost_line_items ADD COLUMN actual_source TEXT`);
    }
    catch { /* already exists */ }
    ...
    try {
        db.exec(`ALTER TABLE cost_line_items ADD COLUMN voided_at INTEGER`);
    }
    catch { /* already exists */ }
    try {
        db.exec(`ALTER TABLE cost_line_items ADD COLUMN void_reason TEXT`);
    }
    catch { /* already exists */ }
    ...
    try {
        db.exec(`ALTER TABLE cost_line_items ADD COLUMN corrects_line_id INTEGER REFERENCES cost_line_items(id)`);
    }
    catch { /* already exists */ }
  ...
  `);
    ...
    try {
        db.exec(`ALTER TABLE import_runs ADD COLUMN detail_json TEXT`);
    }
    catch { /* already exists */ }
  ...
  `);
    ...
    try {
        db.exec(`ALTER TABLE provider_ratelimit_snapshots ADD COLUMN usage_confidence TEXT`);
    }
    catch { /* already exists */ }
    try {
        db.exec(`ALTER TABLE provider_ratelimit_snapshots ADD COLUMN snapshot_source TEXT`);
    }
    catch { /* already exists */ }
    try {
        db.exec(`ALTER TABLE provider_ratelimit_snapshots ADD COLUMN reset_label TEXT`);
    }
    catch { /* already exists */ }
    try {
        db.exec(`ALTER TABLE provider_ratelimit_snapshots ADD COLUMN dedup_key TEXT`);
    }
    catch { /* already exists */ }
    ...
    try {
        db.exec(`ALTER TABLE provider_ratelimit_snapshots ADD COLUMN auth_profile TEXT`);
    }
    catch { /* already exists */ }
  ...
  `);
    ...
    try {
        db.exec(`ALTER TABLE workspace_alerts ADD COLUMN suspension_date INTEGER`);
    }
    catch { /* already exists */ }
