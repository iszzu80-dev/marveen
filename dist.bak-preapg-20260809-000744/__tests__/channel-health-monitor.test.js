...
vi.mock('../web/channel-mcp-reconnect.js', () => ({
    attemptChannelMcpReconnect: (name) => mockReconnect(name),
    resolveAgentSession: (name) => name === 'marveen' ? 'marveen-channels' : `agent-${name}`,
    resolveAgentProviderType: () => 'telegram',
}));
