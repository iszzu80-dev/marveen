...
import { isWorktreeRoot, isTemporaryRoot, shouldRegisterHooks, pruneStaleHookEntries, pruneStaleHooksFromSettingsFile, KNOWN_HOOK_SCRIPTS, } from '../web/hook-registration-guard.js';
...
describe('pruneStaleHookEntries', () => {
    ...
    const fileExists = (p) => liveFiles.has(p);
