...
import { HOOK_NODE_BIN, hookCommand, hookCommandWired, injectEmailSendGate, injectSelfPaceGate, injectEgressGate, ensureEgressGate, ensureGovernanceGateCommands, } from '../web/agent-scaffold.js';
...
describe('hookCommandWired', () => {
    it('finds a freshly injected command (posix path)', () => {
        ...
        const ptuJson = JSON.stringify(s.hooks.PreToolUse);
