...
import { hashPassword, verifyPassword, assertPasswordPolicy, PasswordPolicyError, MIN_PASSWORD_LENGTH, MAX_PASSWORD_LENGTH, } from '../web/password-hash.js';
...
describe('assertPasswordPolicy', () => {
    ...
    it('rejects a non-string', () => {
        expect(() => assertPasswordPolicy(undefined)).toThrow(PasswordPolicyError);
    });
