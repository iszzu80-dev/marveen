...
import { parseHHMM, normalizeAutoRestartConfig, restartDue, dailyDueAtMs, DEFAULT_AUTO_RESTART, } from '../auto-restart.js';
describe('parseHHMM', () => {
    ...
    it('rejects malformed or out-of-range values', () => {
        for (const bad of ['', '3', '24:00', '12:60', '-1:00', 'aa:bb', '12:5', 12, null]) {
