...
export const EXAMPLE_PACKET: ContextPacket = buildContextPacket({
  ...
  references: [
    artifactRefFromContent(
      'docs/optimization/marveen-lean-optimization-audit-2026-07-17.md',
      '9dd1c27',
      EXAMPLE_SOURCES.audit,
      {
 ...
 */
export function renderExamplePacketDoc(): string {
  return (
