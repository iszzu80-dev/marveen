...
export type RoutingStrategy = 'cost' | 'capability'

export interface RoutingResult {
  profile: ModelProfileId | null
  tier: CaseSensitivity
  strategy: RoutingStrategy
  /** Allowed profiles for the tier, most-capable → cheapest. */
  candidates: ModelProfileId[]
  reason: string
}
 ...
 */
export function routeModelForSensitivity(tier: unknown, opts: { strategy?: RoutingStrategy } = {}): RoutingResult {
