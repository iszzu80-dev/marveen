...
All Bearer-gated like every `/api/*` route. Dashboard: "Costs" tab.
...
labelled -- not added to `current_spend`). The Costs tab shows a "Token
cost estimate (ESTIMATE, not an invoice)" section.
