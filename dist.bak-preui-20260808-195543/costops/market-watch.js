...
export function normalizeMarketSnapshot(raw) {
    ...
    function walk(provider, groupPath, node) {
 ...
 */
export function hashSnapshot(normalized) {
 ...
 */
export function diffSnapshots(previous, next, previousHash, newHash, detectedAt) {
 ...
 */
export function runMarketWatchCycle(fetchSnapshot, previous, detectedAt) {
