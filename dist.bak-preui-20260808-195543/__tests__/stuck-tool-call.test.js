...
import { stuckToolCallSignature, decideStuckToolCallRecovery, } from '../pane-state.js';
...
describe('stuck-tool-call-watcher wiring contract', () => {
    ...
    const watcherSrc = require('node:fs').readFileSync(require('node:path').join(__dirname, '../web/stuck-tool-call-watcher.ts'), 'utf-8');
    const webSrc = require('node:fs').readFileSync(require('node:path').join(__dirname, '../web.ts'), 'utf-8');
