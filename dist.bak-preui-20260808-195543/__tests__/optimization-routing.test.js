...
import { listRuntimeOverlays, OVERLAY_PATH, } from '../web/capacity-routing-store.js';
import { buildRoutingSnapshot, previewRuntimeRouting, ROUTING_PREVIEW_FORBIDDEN_CALLS, } from '../optimization/optimization-routing.js';
...
describe('previewRuntimeRouting', () => {
    ...
    it('contains none of the forbidden mutation call names in the source', () => {
        const source = readFileSync(join(__dirname, '../optimization/optimization-routing.ts'), 'utf-8');
