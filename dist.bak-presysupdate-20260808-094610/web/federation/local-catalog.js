...
export const MANIFEST_EXCLUDED_AGENTS = new Set(['heartbeat', COORDINATOR_AGENT_ID, 'channel-coordinator']);
...
export function catalogAgentNames() {
...
export function listAgentLocalSkills(agentName) {
