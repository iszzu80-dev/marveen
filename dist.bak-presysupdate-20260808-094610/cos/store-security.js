 ...
 */
export function assertStorePermissions(entries, opts = {}) {
...
export function anyTooOpen(checks) {
 ...
 */
export function redactSensitive(value, sensitiveKeys = SENSITIVE_FIELD_NAMES) {
