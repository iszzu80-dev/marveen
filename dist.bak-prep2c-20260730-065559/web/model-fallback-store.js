...
import { normalizeModelFallbackConfig, DEFAULT_MODEL_FALLBACK, DEFAULT_MODEL_CHAIN, } from '../model-fallback.js';
...
export function defaultChainForInstall() {
...
function hasExplicitChain(parsed) {
...
export function readModelFallbackConfig() {
    let parsed;
    try {
...
export function writeModelFallbackConfig(cfg) {
