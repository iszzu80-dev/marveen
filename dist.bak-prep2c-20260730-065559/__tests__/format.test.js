...
describe('formatForTelegram', () => {
    ...
    it('inline kodot konvertal', () => {
        expect(formatForTelegram('hasznald a `parancs` kodot')).toBe('hasznald a <code>parancs</code> kodot');
    });
    ...
    it('linkeket konvertal', () => {
        expect(formatForTelegram('[szoveg](https://pelda.hu)')).toBe('<a href="https://pelda.hu">szoveg</a>');
    });
