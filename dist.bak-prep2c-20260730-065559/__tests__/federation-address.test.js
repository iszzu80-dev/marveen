...
import { parseQualifiedId, isQualifiedId, isValidIdSegment, formatQualifiedId, federationSource, } from '../web/federation/address.js';
...
describe('parseQualifiedId', () => {
    ...
    it('returns null for non-strings', () => {
        ...
        expect(parseQualifiedId(42)).toBeNull();
    });
