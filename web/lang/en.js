...
window._i18n.en = {
  ...
  'optimization.page_title':    'Optimization',
  'optimization.page_subtitle': 'Model, capacity, cost and package optimization',
  'optimization.no_data':       'No data',
  'optimization.tab.overview':  'Overview',
  'optimization.tab.routing':   'Routing & Capacity',
  'optimization.tab.decisions': 'Decisions',
  'optimization.tab.controls':  'Controls',
  'optimization.status.ok':                 'OK',
  'optimization.status.observation':        'Observation',
  'optimization.status.attention_needed':   'Attention needed',
  'optimization.status.partially_disabled': 'Partially disabled',
  'optimization.status.disabled':           'Disabled',
  'optimization.status.modules':    '{active}/{total} modules',
  'optimization.status.freshness':  'Updated {value}',
  'optimization.badge.measured':  'Measured',
  'optimization.badge.estimated': 'Estimated',
  'optimization.badge.unknown':   'Unknown',
  'optimization.badge.available': 'Available',
  'optimization.badge.degraded':  'Degraded',
  'optimization.badge.limited':   'Limited',
  'optimization.badge.blocked':   'Blocked',
  'optimization.badge.ok':        'OK',
  'optimization.badge.warning':   'Warning',
  'optimization.badge.critical':  'Critical',
  'optimization.attention.none':  'No items need attention.',
  'optimization.badge.manual': 'Manual',
  'optimization.badge.inferred': 'Inferred',
  'optimization.common.all': 'All',
  'optimization.common.on': 'On',
  'optimization.common.off': 'Off',
  'optimization.common.yes': 'Yes',
  'optimization.common.no': 'No',
  'optimization.loading': 'Loading...',
  'optimization.error_with_message': 'Error: {message}',
  'optimization.http_error': 'Request failed ({status})',
  'optimization.severity.info': 'Info',
  'optimization.severity.warning': 'Warning',
  'optimization.severity.critical': 'Critical',
  'optimization.verdict.keep': 'KEEP',
  'optimization.verdict.upgrade': 'UPGRADE',
  'optimization.verdict.downgrade': 'DOWNGRADE',
  'optimization.verdict.cancel': 'CANCEL',
  'optimization.verdict.add': 'ADD',
  'optimization.verdict.enable_usage_credit': 'ENABLE USAGE CREDIT',
  'optimization.verdict.rebalance': 'REBALANCE',
  'optimization.verdict.no_decision': 'NO DECISION',
  'optimization.verdict.insufficient_evidence': 'INSUFFICIENT EVIDENCE',
  'optimization.verdict.unknown': 'Unknown',
  'optimization.evidence.price_huf': 'Price (HUF)',
  'optimization.module.measurement.name': 'Measurement & attribution',
  'optimization.module.measurement.desc': 'Measures dispatches, routing events, outcomes and CostOps attribution.',
  'optimization.module.contextEfficiency.name': 'Context efficiency',
  'optimization.module.contextEfficiency.desc': 'Context Packet, fresh token budget and checkpoint handling.',
  'optimization.module.capacityMonitoring.name': 'Capacity monitoring',
  'optimization.module.capacityMonitoring.desc': 'Collects subscription usage and capacity state.',
  'optimization.module.runtimeRouting.name': 'Runtime routing',
  'optimization.module.runtimeRouting.desc': 'Capacity-aware automatic runtime fallback.',
  'optimization.module.recommendations.name': 'Recommendations',
  'optimization.module.recommendations.desc': 'Computes package-level KEEP/UPGRADE/DOWNGRADE recommendations.',
  'optimization.module.marketWatch.name': 'Market watch',
  'optimization.module.marketWatch.desc': 'Watches for market price changes (not yet scheduled today).',
  'optimization.module.benchmarkRecommendations.name': 'Benchmark & canary',
  'optimization.module.benchmarkRecommendations.desc': 'Marveen-specific cost benchmark and canary suggestions.',
  'optimization.overview.system_state': 'System state',
  'optimization.overview.active_modules': '{active}/{total} modules active',
  'optimization.overview.decisions_waiting': 'Decisions waiting',
  'optimization.overview.open_decisions': 'open items on the attention list',
  'optimization.overview.capacity_risk': 'Capacity risk',
  'optimization.overview.cost_per_accepted_task': 'Cost / accepted task',
  'optimization.overview.attention_title': 'What needs attention?',
  'optimization.overview.capacity_title': 'Capacity summary',
  'optimization.overview.routing_title': 'Routing snapshot',
  'optimization.overview.top_recommendation_title': 'Top recommendation',
  'optimization.overview.capacity_unavailable': 'Capacity monitoring disabled or unavailable',
  'optimization.overview.capacity_none': 'No subscriptions configured',
  'optimization.overview.capacity_usage_label': 'Usage',
  'optimization.overview.capacity_unused_label': 'Unused capacity',
  'optimization.overview.capacity_overflow_label': 'Overflow',
  'optimization.overview.capacity_usage': '{name} usage',
  'optimization.overview.capacity_overflow': '{name} overflow',
  'optimization.overview.benchmark_no_measured_group': 'No group with a measured marginal cost',
  'optimization.overview.benchmark_group': '{period}, {tasks} accepted tasks',
  'optimization.overview.fallback_agents': 'Agents on fallback',
  'optimization.overview.fallback_none': 'No agent is currently on fallback',
  'optimization.overview.runtime_enabled': 'Runtime routing enabled',
  'optimization.overview.candidate_count': 'Fallback candidates',
  'optimization.overview.trusted_candidate_count': 'Of which trusted',
  'optimization.overview.go_routing': 'Open full routing view',
  'optimization.overview.top_recommendation_none': 'No current change recommendation',
  'optimization.overview.confidence': 'Confidence',
  'optimization.overview.review': 'Review on the Decisions tab',
  'optimization.routing.state.primary': 'Primary',
  'optimization.routing.state.fallback': 'Fallback',
  'optimization.routing.state.static_mode': 'Static mode',
  'optimization.routing.state.unknown': 'Unknown',
  'optimization.routing.action.stay_primary': 'Stay on primary',
  'optimization.routing.action.hold_current_overlay': 'Hold current overlay',
  'optimization.routing.action.fallback': 'Would fall back',
  'optimization.routing.action.no_eligible_fallback': 'No eligible fallback candidate',
  'optimization.routing.action.ceiling_reached': 'Automatic fallback ceiling reached',
  'optimization.routing.action.unknown': 'Unknown decision',
  'optimization.routing.none': 'No agents to display',
  'optimization.routing.filter_agent': 'Agent filter',
  'optimization.routing.filter_state': 'Routing state',
  'optimization.routing.filter_problematic': 'Problematic only',
  'optimization.routing.no_agents': 'No agents available',
  'optimization.routing.no_fallback_reason': '—',
  'optimization.routing.column.agent': 'Agent',
  'optimization.routing.column.configured_primary': 'Configured primary',
  'optimization.routing.column.runtime_model': 'Runtime model',
  'optimization.routing.column.capacity_state': 'Capacity',
  'optimization.routing.column.routing_state': 'Routing state',
  'optimization.routing.column.fallback_reason': 'Fallback reason',
  'optimization.routing.preview_title': 'Routing preview',
  'optimization.routing.preview_readonly_note': 'Read-only preview -- does not start a real dispatch and changes nothing.',
  'optimization.routing.preview_agent': 'Select agent',
  'optimization.routing.preview_button': 'Preview',
  'optimization.routing.preview_empty': 'Select an agent to preview',
  'optimization.routing.preview_action': 'Decision',
  'optimization.routing.preview_would_change': 'Would routing change?',
  'optimization.decisions.status.new': 'New',
  'optimization.decisions.status.viewed': 'Viewed',
  'optimization.decisions.status.accepted': 'Accepted',
  'optimization.decisions.status.rejected': 'Rejected',
  'optimization.decisions.status.deferred': 'Deferred',
  'optimization.decisions.status.canary_needed': 'Canary needed',
  'optimization.decisions.status.executed': 'Executed',
  'optimization.decisions.status.expired': 'Expired',
  'optimization.decisions.status.insufficient_evidence': 'Insufficient evidence',
  'optimization.decisions.status.missing': 'Unknown status',
  'optimization.decisions.action.viewed': 'Mark viewed',
  'optimization.decisions.action.accepted': 'Accept',
  'optimization.decisions.action.rejected': 'Reject',
  'optimization.decisions.action.deferred': 'Defer',
  'optimization.decisions.action.canary_needed': 'Request canary',
  'optimization.decisions.filter_status': 'Status filter',
  'optimization.decisions.local_only_note': 'The decision is recorded locally only -- no external/commercial action is ever triggered automatically.',
  'optimization.decisions.none': 'No recommendations to display',
  'optimization.decisions.evidence_title': 'Evidence',
  'optimization.decisions.evidence_none': 'No evidence data',
  'optimization.decisions.manual_external_action_note': 'Accepting this does not automatically purchase, cancel or change any package -- the real-world step must be done manually, outside this dashboard.',
  'optimization.decisions.no_actions': 'No actions available for this item.',
  'optimization.decisions.defer_prompt': 'Defer until when? (epoch seconds, leave blank for indefinite)',
  'optimization.decisions.defer_invalid': 'Invalid value -- enter a positive whole number (epoch seconds) or leave it blank.',
  'optimization.decisions.confirm_action': 'Confirm: {action} -- {package}?',
  'optimization.decisions.action_success': '{package} status is now: {status}',
  'optimization.controls.master_title': 'Master switch',
  'optimization.controls.master_label': 'Optimization system',
  'optimization.controls.master_desc': 'Turning this off deletes no data and rewrites no agent config -- only the optional modules stop.',
  'optimization.controls.preset_title': 'Current preset',
  'optimization.controls.preset.off': 'Off',
  'optimization.controls.preset.observation': 'Observation',
  'optimization.controls.preset.advisory': 'Advisory',
  'optimization.controls.preset.active': 'Active',
  'optimization.controls.preset.custom': 'Custom',
  'optimization.controls.preset.unknown': 'Unknown',
  'optimization.controls.preset_readonly_note': 'The preset is computed automatically from the module toggles below -- adjust the modules and the preset label updates itself.',
  'optimization.controls.modules_title': 'Module toggles',
  'optimization.controls.emergency_title': 'Emergency stop',
  ...
  'optimization.controls.preview_modules': 'This will be in effect after saving:',
  'optimization.controls.save_success': 'Configuration saved.',
  ...
  'settings.desc.APG_MODE':                        'Global operating mode for the APG 0.4 Lean control layer. Off by default.',
  'settings.desc.APG_UI_OVERVIEW':                 'APG summary and attention list on the Overview page.',
  'settings.desc.APG_UI_KANBAN':                   'APG indicators (badge, filters, card detail) on the Kanban board.',
  'settings.desc.APG_UI_ACTIVITY':                 'APG events in the Activity feed.',
  'settings.desc.APG_UI_EVIDENCE':                 'Claim/receipt evidence panels.',
  'settings.desc.APG_UI_APPROVAL_ENHANCEMENTS':    'APG decision cards on the Approvals page.',
  'settings.desc.APG_OWNER_NOTIFICATIONS':         'Channel notifications when an APG owner decision is needed.',
  'settings.desc.APG_REQUIRE_CLAIM_RECEIPT':       'Only blocks in Enforced mode: claims without a receipt cannot be used as facts.',
  'settings.desc.APG_REQUIRE_INDEPENDENT_ACCEPTANCE': 'Only blocks in Enforced mode: the producer cannot be their own final accepter.',
  'settings.desc.APG_REQUIRE_OWNER_DECISION':      'Only blocks in Enforced mode: a gate cannot open without a mandatory owner decision.',
  'settings.desc.APG_BLOCK_UNACCEPTED_ARCHIVE':    'Only blocks in Enforced mode: a card with an unaccepted linked work item cannot be archived automatically.',
  ...
  'agents.toast.plan_saved':       'Plan saved, applies after restart',
  ...
  'onboarding.step2.desc_slack':       'Provide your Slack bot token (from your Slack App settings).',
  'onboarding.step2.token_label_slack':'Slack bot token',
  'onboarding.step2.token_hint_slack': 'The Bot User OAuth Token from your Slack App (xoxb-...).',
  'onboarding.step2.app_token_label_slack':'Slack app-level token',
  'onboarding.step2.app_token_hint_slack': 'The App-Level Token from your Slack App, needed for Socket Mode (xapp-...).',
  'onboarding.step2.app_token_empty_slack': 'Paste the app-level token too (xapp-...) -- without it Slack cannot connect.',
  ...
  'onboarding.step3.li1':        'Send a message to your bot on Telegram or Slack.',
  ...
  // --- APG 0.4 Lean UI ---
  'apg.state.clarification':          'Clarification',
  'apg.state.evidence_needed':        'Evidence needed',
  'apg.state.executing':              'Executing',
  'apg.state.verifying':              'Verifying',
  'apg.state.decision_needed':        'Decision needed',
  'apg.state.blocked':                'Blocked',
  'apg.state.accepted':               'Accepted',
  'apg.state.off':                    'Disabled',

  'apg.overview.title':               'APG 0.4 Lean',
  'apg.overview.subtitle':            'Evidence-driven control layer -- what is happening, what is stuck, what needs a decision.',
  'apg.overview.attention':           'Needs attention',
  'apg.overview.no_active_work':      'No active APG work items.',
  'apg.overview.empty':               'APG found nothing that needs attention.',
  'apg.overview.active':              'Active',
  'apg.overview.evidence_needed':     'Evidence needed',
  'apg.overview.decision_needed':     'Decision needed',
  'apg.overview.blocked':             'Blocked',
  'apg.overview.verifying':           'Verifying',
  'apg.overview.accepted_today':      'Accepted today',

  'apg.kanban.filter.attention':          'APG: Needs attention',
  'apg.kanban.filter.decision':           'APG: Decision needed',
  'apg.kanban.filter.blocked':            'APG: Blocked',
  'apg.kanban.filter.verifying':          'APG: Verifying',
  ...
  'apg.detail.next_action':           'Next action',
  'apg.detail.goal':                  'Goal',
  'apg.detail.scope':                 'Scope',
  'apg.detail.claims':                'Claims',
  'apg.detail.no_claims':             'No claims recorded.',
  'apg.detail.events':                'Events',
  'apg.detail.no_events':             'No events recorded.',
  ...
  'apg.approvals.decision_needed':              'Decision needed',
  'apg.approvals.saved':                        'Decision recorded.',
  'apg.approvals.action.accept':                'Accept',
  'apg.approvals.action.request_evidence':      'Request more evidence',
  'apg.approvals.action.return_for_fix':        'Return for fix',
  'apg.approvals.action.block':                 'Block',
  'apg.approvals.block_prompt':                 'Reason for blocking:',
  'apg.approvals.block_required':               'A reason is required to block.',
  'apg.approvals.block_confirm':                'Are you sure you want to block this APG decision?',
  ...
  'apg.common.close':                 'Close',
  'apg.common.degraded':              'APG state is currently unreadable. The rest of Marveen keeps working.',
