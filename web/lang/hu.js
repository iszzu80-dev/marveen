...
window._i18n.hu = {
  ...
  'nav.costs':        'Költségek',
  'nav.optimization': 'Optimalizálás',

  // --- Optimization dashboard (card 12d5c98d) ---
  'optimization.page_title':    'Optimalizálás',
  'optimization.page_subtitle': 'Modell-, kapacitás-, költség- és csomagoptimalizálás',
  'optimization.no_data':       'Nincs adat',
  'optimization.tab.overview':  'Áttekintés',
  'optimization.tab.routing':   'Routing és kapacitás',
  'optimization.tab.decisions': 'Döntések',
  'optimization.tab.controls':  'Vezérlés',
  'optimization.status.ok':                 'Rendben',
  'optimization.status.observation':        'Megfigyelés',
  'optimization.status.attention_needed':   'Figyelmet igényel',
  'optimization.status.partially_disabled': 'Részben kikapcsolva',
  'optimization.status.disabled':           'Kikapcsolva',
  'optimization.status.modules':    '{active}/{total} modul',
  'optimization.status.freshness':  'Frissítve {value}',
  'optimization.badge.measured':  'Mért',
  'optimization.badge.estimated': 'Becsült',
  'optimization.badge.unknown':   'Ismeretlen',
  'optimization.badge.available': 'Elérhető',
  'optimization.badge.degraded':  'Csökkent',
  'optimization.badge.limited':   'Korlátozott',
  'optimization.badge.blocked':   'Blokkolt',
  'optimization.badge.ok':        'Rendben',
  'optimization.badge.warning':   'Figyelmeztetés',
  'optimization.badge.critical':  'Kritikus',
  'optimization.attention.none':  'Nincs beavatkozást igénylő esemény.',
  'optimization.badge.manual': 'Kézi',
  'optimization.badge.inferred': 'Levezetett',
  'optimization.common.all': 'Mind',
  'optimization.common.on': 'Be',
  'optimization.common.off': 'Ki',
  'optimization.common.yes': 'Igen',
  'optimization.common.no': 'Nem',
  'optimization.loading': 'Betöltés...',
  'optimization.error_with_message': 'Hiba: {message}',
  'optimization.http_error': 'Kérés sikertelen ({status})',
  'optimization.severity.info': 'Info',
  'optimization.severity.warning': 'Figyelmeztetés',
  'optimization.severity.critical': 'Kritikus',
  'optimization.verdict.keep': 'MEGTARTÁS',
  'optimization.verdict.upgrade': 'FEJLESZTÉS',
  'optimization.verdict.downgrade': 'VISSZAMINŐSÍTÉS',
  'optimization.verdict.cancel': 'LEMONDÁS',
  'optimization.verdict.add': 'HOZZÁADÁS',
  'optimization.verdict.enable_usage_credit': 'HASZNÁLATI KREDIT BEKAPCSOLÁSA',
  'optimization.verdict.rebalance': 'ÁTCSOPORTOSÍTÁS',
  'optimization.verdict.no_decision': 'NINCS DÖNTÉS',
  'optimization.verdict.insufficient_evidence': 'NEM ELÉG BIZONYÍTÉK',
  'optimization.verdict.unknown': 'Ismeretlen',
  'optimization.evidence.price_huf': 'Ár (Ft)',
  'optimization.module.measurement.name': 'Mérés és attribution',
  'optimization.module.measurement.desc': 'Dispatch/routing esemény, outcome és CostOps attribution mérése.',
  'optimization.module.contextEfficiency.name': 'Context efficiency',
  'optimization.module.contextEfficiency.desc': 'Context Packet, fresh token budget és checkpoint kezelés.',
  'optimization.module.capacityMonitoring.name': 'Kapacitásfigyelés',
  'optimization.module.capacityMonitoring.desc': 'Előfizetés-kihasználtság és kapacitásállapot gyűjtése.',
  'optimization.module.runtimeRouting.name': 'Runtime routing',
  'optimization.module.runtimeRouting.desc': 'Kapacitás-alapú automatikus fallback futásidőben.',
  'optimization.module.recommendations.name': 'Ajánlások',
  'optimization.module.recommendations.desc': 'Csomagszintű KEEP/UPGRADE/DOWNGRADE ajánlások számítása.',
  'optimization.module.marketWatch.name': 'Piacfigyelés',
  'optimization.module.marketWatch.desc': 'Piaci árváltozások figyelése (jelenleg nincs ütemezve).',
  'optimization.module.benchmarkRecommendations.name': 'Benchmark és canary',
  'optimization.module.benchmarkRecommendations.desc': 'Marveen-specifikus költség-benchmark és canary javaslatok.',
  'optimization.overview.system_state': 'Rendszerállapot',
  'optimization.overview.active_modules': '{active}/{total} modul aktív',
  'optimization.overview.decisions_waiting': 'Döntésre vár',
  'optimization.overview.open_decisions': 'nyitott tétel a figyelmeztető listán',
  'optimization.overview.capacity_risk': 'Kapacitáskockázat',
  'optimization.overview.cost_per_accepted_task': 'Költség / elfogadott feladat',
  'optimization.overview.attention_title': 'Mi igényel figyelmet?',
  'optimization.overview.capacity_title': 'Kapacitásösszefoglaló',
  'optimization.overview.routing_title': 'Routing pillanatkép',
  'optimization.overview.top_recommendation_title': 'Legfontosabb ajánlás',
  'optimization.overview.capacity_unavailable': 'Kapacitásfigyelés kikapcsolva vagy nem elérhető',
  'optimization.overview.capacity_none': 'Nincs konfigurált előfizetés',
  'optimization.overview.capacity_usage_label': 'Kihasználtság',
  'optimization.overview.capacity_unused_label': 'Ki nem használt kapacitás',
  'optimization.overview.capacity_overflow_label': 'Túllépés',
  'optimization.overview.capacity_usage': '{name} kihasználtsága',
  'optimization.overview.capacity_overflow': '{name} túllépése',
  'optimization.overview.benchmark_no_measured_group': 'Nincs mért marginális költségű csoport',
  'optimization.overview.benchmark_group': '{period}, {tasks} elfogadott feladat',
  'optimization.overview.fallback_agents': 'Fallbacken futó agentek',
  'optimization.overview.fallback_none': 'Egyik agent sem fut fallbacken',
  'optimization.overview.runtime_enabled': 'Runtime routing engedélyezve',
  'optimization.overview.candidate_count': 'Fallback jelöltek száma',
  'optimization.overview.trusted_candidate_count': 'Ebből megbízható (trusted)',
  'optimization.overview.go_routing': 'Összes routing megnyitása',
  'optimization.overview.top_recommendation_none': 'Nincs aktuális változtatási javaslat',
  'optimization.overview.confidence': 'Bizonyosság',
  'optimization.overview.review': 'Áttekintés a Döntések fülön',
  'optimization.routing.state.primary': 'Elsődleges',
  'optimization.routing.state.fallback': 'Fallback',
  'optimization.routing.state.static_mode': 'Statikus mód',
  'optimization.routing.state.unknown': 'Ismeretlen',
  'optimization.routing.action.stay_primary': 'Marad az elsődlegesen',
  'optimization.routing.action.hold_current_overlay': 'Jelenlegi overlay megtartása',
  'optimization.routing.action.fallback': 'Fallbackre váltana',
  'optimization.routing.action.no_eligible_fallback': 'Nincs megfelelő fallback jelölt',
  'optimization.routing.action.ceiling_reached': 'Automatikus fallback plafon elérve',
  'optimization.routing.action.unknown': 'Ismeretlen döntés',
  'optimization.routing.none': 'Nincs megjeleníthető agent',
  'optimization.routing.filter_agent': 'Agent szűrő',
  'optimization.routing.filter_state': 'Routing állapot',
  'optimization.routing.filter_problematic': 'Csak problémás',
  'optimization.routing.no_agents': 'Nincs elérhető agent',
  'optimization.routing.no_fallback_reason': '—',
  'optimization.routing.column.agent': 'Agent',
  'optimization.routing.column.configured_primary': 'Konfigurált elsődleges',
  'optimization.routing.column.runtime_model': 'Futásidejű modell',
  'optimization.routing.column.capacity_state': 'Kapacitás',
  'optimization.routing.column.routing_state': 'Routing állapot',
  'optimization.routing.column.fallback_reason': 'Fallback oka',
  'optimization.routing.preview_title': 'Routing előnézet',
  'optimization.routing.preview_readonly_note': 'Csak olvasható előnézet -- nem indít valós dispatch-et és nem módosít semmit.',
  'optimization.routing.preview_agent': 'Agent kiválasztása',
  'optimization.routing.preview_button': 'Előnézet',
  'optimization.routing.preview_empty': 'Válassz agentet az előnézethez',
  'optimization.routing.preview_action': 'Döntés',
  'optimization.routing.preview_would_change': 'Változna a routing?',
  'optimization.decisions.status.new': 'Új',
  'optimization.decisions.status.viewed': 'Megtekintett',
  'optimization.decisions.status.accepted': 'Elfogadott',
  'optimization.decisions.status.rejected': 'Elutasított',
  'optimization.decisions.status.deferred': 'Elhalasztott',
  'optimization.decisions.status.canary_needed': 'Canary szükséges',
  'optimization.decisions.status.executed': 'Végrehajtva',
  'optimization.decisions.status.expired': 'Lejárt',
  'optimization.decisions.status.insufficient_evidence': 'Nem elég bizonyíték',
  'optimization.decisions.status.missing': 'Ismeretlen állapot',
  'optimization.decisions.action.viewed': 'Megtekintve',
  'optimization.decisions.action.accepted': 'Elfogadom',
  'optimization.decisions.action.rejected': 'Elutasítom',
  'optimization.decisions.action.deferred': 'Elhalasztom',
  'optimization.decisions.action.canary_needed': 'Canary kérése',
  'optimization.decisions.filter_status': 'Státusz szűrő',
  'optimization.decisions.local_only_note': 'A döntés csak helyben rögzül -- semmilyen külső/kereskedelmi művelet nem indul automatikusan.',
  'optimization.decisions.none': 'Nincs megjeleníthető ajánlás',
  'optimization.decisions.evidence_title': 'Bizonyíték',
  'optimization.decisions.evidence_none': 'Nincs bizonyíték-adat',
  'optimization.decisions.manual_external_action_note': 'Ez a döntés nem vásárol, mond le vagy módosít semmilyen csomagot automatikusan -- a tényleges lépést kézzel, a dashboardon kívül kell elvégezni.',
  'optimization.decisions.no_actions': 'Ehhez a tételhez nincs elérhető művelet.',
  'optimization.decisions.defer_prompt': 'Meddig halasszuk el? (epoch másodperc, üresen hagyva határidő nélkül)',
  'optimization.decisions.defer_invalid': 'Érvénytelen érték -- pozitív egész szám (epoch másodperc) vagy üres mező szükséges.',
  'optimization.decisions.confirm_action': 'Biztosan végrehajtod: {action} -- {package}?',
  'optimization.decisions.action_success': '{package} állapota mostantól: {status}',
  'optimization.controls.master_title': 'Master kapcsoló',
  'optimization.controls.master_label': 'Optimalizálási rendszer',
  'optimization.controls.master_desc': 'Kikapcsoláskor nem törlődik adat és nem íródik át agent-konfiguráció -- csak az opcionális modulok állnak le.',
  'optimization.controls.preset_title': 'Aktuális preset',
  'optimization.controls.preset.off': 'Kikapcsolva',
  'optimization.controls.preset.observation': 'Megfigyelés',
  'optimization.controls.preset.advisory': 'Tanácsadó',
  'optimization.controls.preset.active': 'Aktív',
  'optimization.controls.preset.custom': 'Egyedi',
  'optimization.controls.preset.unknown': 'Ismeretlen',
  'optimization.controls.preset_readonly_note': 'A preset a modulkapcsolókból számolódik ki automatikusan -- állítsd a modulokat lent, a preset-címke magától frissül.',
  'optimization.controls.modules_title': 'Modulkapcsolók',
  'optimization.controls.emergency_title': 'Vészleállítás',
  ...
  'optimization.controls.preview_modules': 'Ez lesz érvényben a mentés után:',
  'optimization.controls.save_success': 'Konfiguráció mentve.',
  ...
  'settings.desc.APG_MODE':                        'Az APG 0.4 Lean kontrollreteg globalis uzemmodja. Alapertelmezetten kikapcsolva.',
  'settings.desc.APG_UI_OVERVIEW':                 'APG osszefoglalo es figyelem-lista az Attekintes oldalon.',
  'settings.desc.APG_UI_KANBAN':                   'APG jelzesek (badge, szuro, kartyareszlet) a Kanbanon.',
  'settings.desc.APG_UI_ACTIVITY':                 'APG esemenyek az Aktivitas feedben.',
  'settings.desc.APG_UI_EVIDENCE':                 'Claim/receipt bizonyitek-panelek.',
  'settings.desc.APG_UI_APPROVAL_ENHANCEMENTS':    'APG dontesi kartya a Jovahagyasok oldalon.',
  'settings.desc.APG_OWNER_NOTIFICATIONS':         'Csatornas ertesites APG owner-dontes szuksegen.',
  'settings.desc.APG_REQUIRE_CLAIM_RECEIPT':       'Csak Kotelezo kapuk modban blokkol: receipt nelkuli claim nem hasznalhato tenykent.',
  'settings.desc.APG_REQUIRE_INDEPENDENT_ACCEPTANCE': 'Csak Kotelezo kapuk modban blokkol: a producer nem lehet sajat vegso accepter.',
  'settings.desc.APG_REQUIRE_OWNER_DECISION':      'Csak Kotelezo kapuk modban blokkol: kotelezo owner-dontes nelkul a gate nem nyilik.',
  'settings.desc.APG_BLOCK_UNACCEPTED_ARCHIVE':    'Csak Kotelezo kapuk modban blokkol: el nem fogadott linkelt work item eseten a kartya nem kerulhet automatikus archivumba.',
  ...
  'onboarding.step2.tab_slack':        'Slack bot',
  'onboarding.step2.desc_slack':       'Add meg a Slack bot tokenjét (a Slack App beállításaidból).',
  'onboarding.step2.token_label_slack':'Slack bot token',
  'onboarding.step2.token_hint_slack': 'A Slack App Bot User OAuth Tokenje (xoxb-...).',
  'onboarding.step2.app_token_label_slack':'Slack app-szintű token',
  'onboarding.step2.app_token_hint_slack': 'A Slack App App-Level Tokenje a Socket Mode-hoz (xapp-...).',
  'onboarding.step2.app_token_empty_slack': 'Illeszd be az app-szintű tokent is (xapp-...) -- enélkül a Slack nem tud kapcsolódni.',
  ...
  'onboarding.step3.li1':        'Írj egy üzenetet a botodnak Telegramon vagy Slacken.',
  ...
  // --- APG 0.4 Lean UI ---
  'apg.state.clarification':          'Tisztázás',
  'apg.state.evidence_needed':        'Bizonyíték szükséges',
  'apg.state.executing':              'Végrehajtás alatt',
  'apg.state.verifying':              'Ellenőrzés alatt',
  'apg.state.decision_needed':        'Döntésre vár',
  'apg.state.blocked':                'Blokkolt',
  'apg.state.accepted':               'Elfogadva',
  'apg.state.off':                    'Kikapcsolva',

  'apg.overview.title':               'APG 0.4 Lean',
  'apg.overview.subtitle':            'Bizonyítékvezérelt kontrollréteg -- mi folyik, mi áll, miben kell dönteni.',
  'apg.overview.attention':           'Figyelmet igényel',
  'apg.overview.no_active_work':      'Nincs aktív APG-folyamat.',
  'apg.overview.empty':               'Az APG nem talált figyelmet igénylő folyamatot.',
  'apg.overview.active':              'Aktív',
  'apg.overview.evidence_needed':     'Bizonyíték szükséges',
  'apg.overview.decision_needed':     'Döntésre vár',
  'apg.overview.blocked':             'Blokkolt',
  'apg.overview.verifying':           'Ellenőrzés alatt',
  'apg.overview.accepted_today':      'Ma elfogadva',

  'apg.kanban.filter.attention':          'APG: Figyelmet kér',
  'apg.kanban.filter.decision':           'APG: Döntésre vár',
  'apg.kanban.filter.blocked':            'APG: Blokkolt',
  'apg.kanban.filter.verifying':          'APG: Ellenőrzés alatt',
  ...
  'apg.detail.next_action':           'Következő lépés',
  'apg.detail.goal':                  'Cél',
  'apg.detail.scope':                 'Hatókör',
  'apg.detail.claims':                'Bizonyítékok',
  'apg.detail.no_claims':             'Nincs rögzített bizonyíték.',
  'apg.detail.events':                'Események',
  'apg.detail.no_events':             'Nincs rögzített esemény.',
  ...
  'apg.approvals.decision_needed':              'Döntésre vár',
  'apg.approvals.saved':                        'A döntés rögzítve.',
  'apg.approvals.action.accept':                'Elfogadom',
  'apg.approvals.action.request_evidence':      'További bizonyíték kell',
  'apg.approvals.action.return_for_fix':        'Visszaküldöm javításra',
  'apg.approvals.action.block':                 'Blokkolom',
  'apg.approvals.block_prompt':                 'A blokkolás oka:',
  'apg.approvals.block_required':               'A blokkolás okát kötelező megadni.',
  'apg.approvals.block_confirm':                'Biztosan blokkolod ezt az APG-döntést?',
  'apg.approvals.confirm_generic':              '{action}?',
  ...
  'apg.common.close':                 'Bezárás',
  'apg.common.degraded':              'Az APG állapota jelenleg nem olvasható. A Marveen többi funkciója működik.',
