...
const ctxSlow = makeWorkerCtx(process.env.MARVEEN_WORKER_SESSION || `${MAIN_AGENT_ID}-worker`, process.env.MARVEEN_WORKER_DIR || join(homedir(), '.marveen-worker'));
...
const ctxFast = makeWorkerCtx(process.env.MARVEEN_WORKER_SESSION_FAST || `${MAIN_AGENT_ID}-worker-fast`, process.env.MARVEEN_WORKER_DIR_FAST || join(homedir(), '.marveen-worker-fast'));
