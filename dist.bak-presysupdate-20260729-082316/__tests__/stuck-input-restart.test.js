...
const decide = (over = {}) => decideStuckInputRestart(over.parked ?? true, over.attempts ?? MAX_ATTEMPTS, MAX_ATTEMPTS, NOW, over.last ?? 0, over.count ?? 0, MIN_INTERVAL, MAX_CONSEC);
