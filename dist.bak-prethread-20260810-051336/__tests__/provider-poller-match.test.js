...
const TELEGRAM_CACHE_CMD = 'bun run --cwd /home/user/.claude/plugins/cache/claude-plugins-official/telegram/0.0.6 --shell=bun --silent start';
const TELEGRAM_MARKETPLACE_CMD = 'bun run --cwd /home/user/.claude/plugins/marketplaces/claude-plugins-official/external_plugins/telegram --shell=bun --silent start';
const SYNOLOGY_CHAT_CMD = 'bun run --cwd /home/user/.claude/plugins/efi-src/synology-chat --shell=bun --silent start';
...
const SLACK_CHANNEL_CMD = 'node /home/user/.claude/plugins/marketplaces/marveen-marketplace/slack-channel/0.1.0/server.js';
const SLACK_BUN_CMD = 'bun run --cwd /home/user/.claude/plugins/cache/marveen-marketplace/slack-channel/0.1.0 --silent start';
const DISCORD_CACHE_CMD = 'bun run --cwd /home/user/.claude/plugins/cache/claude-plugins-official/discord/0.0.4 --shell=bun --silent start';
