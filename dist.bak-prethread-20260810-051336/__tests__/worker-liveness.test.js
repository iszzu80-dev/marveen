...
import { decideWorkerLiveness, sweepWorkerLiveness, tailLines, NO_WORKER_LIVENESS_STATE, DEATH_PANE_LINES, } from '../web/worker-liveness.js';
...
function obs(alive, pane, nowMs, isFirstSweep = false) {
...
describe('decideWorkerLiveness', () => {
    ...
    it('keeps the ORIGINAL first sighting across later polls (lifetime, not age-since-last-poll)', () => {
        let st = decideWorkerLiveness(obs(true, 'a', t0), NO_WORKER_LIVENESS_STATE).next;
