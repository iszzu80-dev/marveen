...
import { resolveSourceForecast, forecastSnapshotDedupKey } from './forecast.js';
function resolveBestLinePerSource(db, win) {
 ...
 */
export function captureForecastSnapshots(db, now) {
    ...
    for (const s of sources) {
        ...
        const ctx = {
            ...
            win,
            now,
            data_confidence: line?.confidence ?? 'manual',
...
export function listForecastSnapshots(db, opts = {}) {
