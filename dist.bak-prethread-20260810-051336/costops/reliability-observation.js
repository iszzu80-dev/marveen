...
export function captureReliabilitySnapshot(db, config, now, deps = {}) {
...
export function listReliabilitySnapshots(db, limit = 30) {
    return db.prepare(`
...
export function getLatestReliabilitySnapshot(db) {
 ...
 */
export function collectorSyncTickSafely() {
 ...
 */
export function startCostOpsBackgroundTasks() {
    captureNowSafely();
