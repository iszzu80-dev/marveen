...
import { normalizeAutoRestartConfig, DEFAULT_AUTO_RESTART, } from '../auto-restart.js';
...
export function readAllAutoRestartConfigs() {
    const raw = readRaw();
    const out = {};
...
export function readAutoRestartConfig(name) {
    const raw = readRaw();
...
export function writeAutoRestartConfig(name, cfg) {
