...
function dayOfWeekBudapest(dateStr) {
...
function lastOccurrence(targetDow, today) {
...
export function parseDateExpression(input) {
    ...
    for (const [name, num] of Object.entries(HU_MONTHS)) {
        ...
        if (weekMatch) {
            ...
            const weekMap = { elso: 0, masodik: 1, harmadik: 2, negyedik: 3 };
...
export async function tryHandleRecall(ctx) {
...
function formatRecallResult(result) {
    return {
