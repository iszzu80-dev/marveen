...
import { readTaskState, writeTaskState, markConsumed, clearTaskState, shouldReplayTaskState, buildTaskStateInjection, } from '../agent-taskstate.js';
...
export async function tryHandleAgentTaskState(ctx) {
    ...
    if (baseMatch && method === 'POST') {
        ...
        const record = writeTaskState(agent, {
            doneSteps: fields.doneSteps,
            alreadyDelegated: fields.alreadyDelegated,
            nextAction: fields.nextAction,
            pendingDecision: fields.pendingDecision,
