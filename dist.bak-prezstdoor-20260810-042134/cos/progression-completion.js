...
export function initializeDoDVerification(db, domain, caseId, criteria, now) {
 ...
 *
 *  Domain-scoped. */
export function satisfyDoDCriterion(db, domain, caseId, criterionIndex, runId, now) {
 ...
 *
 *  Domain-scoped. */
export function autoSatisfyNextDoDCriterion(db, domain, caseId, runId, now) {
 ...
 *  Read-only — no mutation.
 *  Domain-scoped. */
export function canCompleteCase(db, domain, caseId) {
 ...
 *  Domain-scoped. */
export function guardCaseCompletion(db, domain, caseId) {
