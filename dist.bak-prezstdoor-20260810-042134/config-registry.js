...
export const SETTINGS_REGISTRY = [
    ...
    // --- APG 0.4 Lean UI read model (hot-reload via settings-store) ---
    {
        key: 'APG_MODE',
        type: 'string',
        default: 'off',
        valueSet: ['off', 'observe', 'assisted', 'enforced'],
        description: 'Az APG 0.4 Lean kontrollreteg globalis uzemmodja. Alapertelmezetten kikapcsolva.',
        module: 'apg',
        secret: false,
        requiresRestart: false,
    },
    {
        ...
        type: 'boolean',
        default: '1',
        description: 'APG osszefoglalo es figyelem-lista az Attekintes oldalon.',
        module: 'apg',
        secret: false,
        requiresRestart: false,
    },
    {
        ...
        type: 'boolean',
        default: '1',
        description: 'APG jelzesek (badge, szuro, kartyareszlet) a Kanbanon.',
        module: 'apg',
        secret: false,
        requiresRestart: false,
    },
    {
        ...
        type: 'boolean',
        default: '1',
        description: 'APG esemenyek az Aktivitas feedben.',
        module: 'apg',
        secret: false,
        requiresRestart: false,
    },
    {
        ...
        type: 'boolean',
        default: '1',
        description: 'Claim/receipt bizonyitek-panelek.',
        module: 'apg',
        secret: false,
        requiresRestart: false,
    },
    {
        key: 'APG_UI_APPROVAL_ENHANCEMENTS',
        type: 'boolean',
        default: '1',
        description: 'APG dontesi kartya a Jovahagyasok oldalon.',
        module: 'apg',
        secret: false,
        requiresRestart: false,
    },
    {
        key: 'APG_OWNER_NOTIFICATIONS',
        type: 'boolean',
        default: '0',
        description: 'Csatornas ertesites APG owner-dontes szuksegen.',
        module: 'apg',
        secret: false,
        requiresRestart: false,
    },
    {
        key: 'APG_REQUIRE_CLAIM_RECEIPT',
        type: 'boolean',
        default: '0',
        description: 'Csak Kotelezo kapuk modban blokkol: receipt nelkuli claim nem hasznalhato tenykent.',
        module: 'apg',
        secret: false,
        requiresRestart: false,
    },
    {
        key: 'APG_REQUIRE_INDEPENDENT_ACCEPTANCE',
        type: 'boolean',
        default: '0',
        description: 'Csak Kotelezo kapuk modban blokkol: a producer nem lehet sajat vegso accepter.',
        module: 'apg',
        secret: false,
        requiresRestart: false,
    },
    {
        key: 'APG_REQUIRE_OWNER_DECISION',
        type: 'boolean',
        default: '0',
        description: 'Csak Kotelezo kapuk modban blokkol: kotelezo owner-dontes nelkul a gate nem nyilik.',
        module: 'apg',
        secret: false,
        requiresRestart: false,
    },
    {
        key: 'APG_BLOCK_UNACCEPTED_ARCHIVE',
        type: 'boolean',
        default: '0',
        description: 'Csak Kotelezo kapuk modban blokkol: el nem fogadott linkelt work item eseten a kartya nem kerulhet automatikus archivumba.',
        module: 'apg',
        secret: false,
        requiresRestart: false,
    },
