...
import { readAgentModel, resolveAgentModelDetailed, invalidateModelProfileMapCache, AGENTS_BASE_DIR, } from '../web/agent-config.js';
...
afterAll(() => {
    ...
    if (createdStore)
        rmSync(join(PROJECT_ROOT, 'store'), { recursive: true, force: true });
    invalidateModelProfileMapCache();
});
