...
import { initializeDoDVerification, satisfyDoDCriterion, autoSatisfyNextDoDCriterion, evaluateDoDCompleteness, canCompleteCase, guardCaseCompletion, PrematureCompletionError, } from '../cos/progression-completion.js';
...
describe('Checkpoint E.4 — Semantic Completion', () => {
    describe('initializeDoDVerification()', () => {
        ...
        it('throws CrossDomainReadError for cross-domain case', () => {
            ...
            expect(() => initializeDoDVerification(db, 'personal', 'zst-cross', ['Test'], now())).toThrow(CrossDomainReadError);
        });
    });
    ...
    describe('satisfyDoDCriterion()', () => {
        ...
        it('throws CrossDomainReadError for cross-domain case', () => {
            ...
            expect(() => satisfyDoDCriterion(db, 'personal', 'zst-cross', 0, 'run-1', t)).toThrow(CrossDomainReadError);
        });
    });
    ...
    describe('RED-PROOF: DoD not met → cannot complete', () => {
        ...
        it('3 criteria, 2 met — canCompleteCase returns false', () => {
            ...
            initializeDoDVerification(db, 'personal', 'pri-red-1', ['Evidence A produced', 'Evidence B verified', 'Stakeholder C notified'], t);
        ...
        it('3 criteria, 3 met — canCompleteCase returns true', () => {
            ...
            initializeDoDVerification(db, 'personal', 'pri-red-2', ['Evidence A produced', 'Evidence B verified', 'Stakeholder C notified'], t);
        ...
        it('RED-PROOF: single unmet criterion among 5 blocks completion', () => {
            ...
            initializeDoDVerification(db, 'personal', 'pri-red-5', ['C1', 'C2', 'C3', 'C4', 'C5'], t);
            // Satisfy 4 of 5
    ...
    describe('Domain-scoped — CrossDomainReadError', () => {
        ...
        it('initializeDoDVerification throws CrossDomainReadError for cross-domain', () => {
            ...
            expect(() => initializeDoDVerification(db, 'personal', 'zst-dod-err', ['Test'], t)).toThrow(CrossDomainReadError);
        });
        it('satisfyDoDCriterion throws CrossDomainReadError for cross-domain', () => {
            ...
            expect(() => satisfyDoDCriterion(db, 'personal', 'zst-dod-err2', 0, 'r1', t)).toThrow(CrossDomainReadError);
        });
        ...
        it('autoSatisfyNextDoDCriterion throws CrossDomainReadError for cross-domain', () => {
            ...
            expect(() => autoSatisfyNextDoDCriterion(db, 'personal', 'zst-auto-err', 'r1', t)).toThrow(CrossDomainReadError);
        });
    });
});
