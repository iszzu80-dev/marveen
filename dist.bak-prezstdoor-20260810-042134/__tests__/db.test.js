...
import { initDatabase, getSession, setSession, clearSession, saveMemory, recentMemories, decayMemories, getMemoriesForChat, buildFtsMatchExpression, getDb, upsertPendingTaskRetry, insertPendingTaskRetryIfNew, updatePendingTaskRetry, listPendingTaskRetries, getPendingTaskRetry, deletePendingTaskRetry, deletePendingTaskRetryById, markPendingTaskRetryAlert, clearPendingTaskRetryAlert, } from '../db.js';
...
describe('database file permissions', () => {
    ...
    it('WAL sidecar (when present) is tightened to 0o600', () => {
        ...
        if (!existsSync(walPath))
            return; // WAL may not exist on a freshly-initialised empty DB
