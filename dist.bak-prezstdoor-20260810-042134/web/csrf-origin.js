...
export function originMatchesServedHost(origin, host, xForwardedHost) {
    let originHost;
    try {
...
export function isBlockedCrossOriginWrite(method, origin, host, xForwardedHost, allowedOrigins) {
    ...
    if (allowedOrigins.has(origin))
        return false;
    if (originMatchesServedHost(origin, host, xForwardedHost))
        return false;
    return true;
}
